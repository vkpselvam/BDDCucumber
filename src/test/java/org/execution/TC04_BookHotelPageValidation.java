...
public class TC04_BookHotelPageValidation {
	...
	@Test()
	private void f_selectHotelPageTextValidation() {
		try {
			Thread.sleep(1000);
	...
	@Test()
	private void g_selectHotelPageRadioButtonValidation() {
		try {
	...
	@Test()
	private void h_selectHotelPageContinueButtonValidation() {
		try {
	...
	@Test()
	private void i_bookHotelPageTextValidation() {
		try {
			Thread.sleep(1000);
	...
	@Test()
	private void j_bookHotelPageBookNowButtonValidation() {
